...
public enum PandoraError
{
	INTERNAL(0), MAINTENANCE_MODE(1), URL_PARAM_MISSING_METHOD(2), URL_PARAM_MISSING_AUTH_TOKEN(3), URL_PARAM_MISSING_PARTNER_ID(4), URL_PARAM_MISSING_USER_ID(5), SECURE_PROTOCOL_REQUIRED(6), CERTIFICATE_REQUIRED(
			...
			15), READ_ONLY_MODE(1000), INVALID_AUTH_TOKEN(1001), UNKNOWN(1002), UNKNOWN_3(1006), EMAIL_INVALID(1011),PASSWORD_INVALID(1012),EMAIL_ALREADY_USED(1013), INVALID_ZIP(1024), INVALID_BIRTHYEAR(1025), INVALID_BIRTHYEAR_AGE(1026), INVALID_GENDER(1027);
