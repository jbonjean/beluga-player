...
/**
 * Copy of Terra slider skin with added disabled state color changes support.
 */
public class FixedTerraSliderSkin extends SliderSkin
{
	/**
	...
	protected class ThumbSkin extends ComponentSkin
	{
		...
		public void paint(Graphics2D graphics)
		{
			...
			Color buttonBackgroundColorLocal;
			Color buttonBorderColorLocal;
			Color buttonBevelColorLocal;

			if (slider.isEnabled())
			{
				buttonBackgroundColorLocal = buttonBackgroundColor;
				buttonBorderColorLocal = buttonBorderColor;
				buttonBevelColorLocal = buttonBevelColor;
			}
			else
			{
				buttonBackgroundColorLocal = disabledButtonBackgroundColor;
				buttonBorderColorLocal = disabledButtonBorderColor;
				buttonBevelColorLocal = disabledButtonBevelColor;
			}

			graphics.setPaint(new GradientPaint(width / 2f, 0, buttonBevelColorLocal, width / 2f,
					height, buttonBackgroundColorLocal));
		...
		public void focusedChanged(Component component, Component obverseComponent)
		{
			...
			FixedTerraSliderSkin.this.repaintComponent();
		}
	...
	public FixedTerraSliderSkin()
	{
		...
		disabledButtonBevelColor = TerraTheme.brighten(disabledButtonBackgroundColor);
	...
	public void paint(Graphics2D graphics)
	{
		...
		Color trackColorLocal;
		Color buttonBorderColorLocal;

		if (slider.isEnabled())
		{
			trackColorLocal = trackColor;
			buttonBorderColorLocal = buttonBorderColor;
		}
		else
		{
			trackColorLocal = disabledTrackColor;
			buttonBorderColorLocal = disabledButtonBorderColor;
		}
		...
		graphics.setColor(trackColorLocal);
