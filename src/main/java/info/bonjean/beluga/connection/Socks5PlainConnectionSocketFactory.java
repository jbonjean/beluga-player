...
public class Socks5PlainConnectionSocketFactory extends PlainConnectionSocketFactory {
	private final Proxy socks5Proxy;

	public Socks5PlainConnectionSocketFactory(String socks5Host, int socks5Port) {
